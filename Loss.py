...
class Loss():
    def __init__(self, opts):
        ...
        self.learn_intrinsics = opts.learn_intrinsics  
    ...
    def __call__(self, in_data, out_depth, out_pose):
        ...
        if self.learn_intrinsics:
            ...
            intrinsics = in_data['intrinsics']
            intrinsics_inv = in_data['intrinsics_inv']
    ...
    def pair_frame_loss(self, target_fr, target_depth, ref_frame, ref_depth, pose_tar2ref, intrinsics,
        ...
        # tar_rec_depth_diff = (target_depth - target_depth_recon).abs() 
        tar_rec_depth_diff = (target_depth_recon - d2).abs()
        # den = (target_depth + target_depth_recon) 
        ...
        photo_loss = self.compute_photo_loss(target_fr, target_fr_recon, tar_recon_diff, auto_mask, 
                                             depth_mask)
        # depth_diff_2= ((target_depth - target_depth_recon) / (target_depth + target_depth_recon)).clamp(0, 1)
    ...
    def compute_photo_loss(self, target_fr, target_fr_recon, tar_recon_diff, auto_mask, depth_mask):
        ...
        # print(depth_mask.size(), tar_recon_diff.size(), ssim_map.size())
